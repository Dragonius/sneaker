...
export const missiles: Record<string, Missile> = {
    ...
    "AIM-54A-Mk47": new Missile("AIM_54A_Mk47"),
    "AIM-54A-Mk60": new Missile("AIM_54A_Mk60"),
    "AIM-54C-Mk47": new Missile("AIM_54C_Mk47"),
    "AIM-54C-Mk60": new Missile("AIM_54C_Mk60"),
    "AIM-7F": new Missile("AIM_7F"),
    "AIM-7MH": new Missile("AIM_7MH"),
